...
<section class="container section section__height">
    ...
    <div class="now-studying">
        ...
        <div class="row">
            ...
            <div class="mapel col-md-4 mb-3">
                <div class="card shadow p-3" data-toggle="collapse" href="#pembelajaran-sekarang" role="button"
                    aria-expanded="false" aria-controls="pembelajaran-sekarang">
                    <div class="jadwal">
                        <div class="mapel">
                            <div class="d-flex justify-content-lg-start">
                                <img role="button"
                                    src="<?= ($nowStudying->profile == 'default_profile.png') ? base_url('assets/siswa/img/profile.png') : base_url('storage/guru/profile/' . $nowStudying->profile) ?>"
                                    alt="" class="rounded-circle mr-3" data-toggle="tooltip" data-placement="top"
                                    title="<?= $nowStudying->guru_nama ?>">
                                ...
                                <a
                                    href="<?= base_url('siswa/absensi/ruang_absensi/' . $this->secure->encrypt_url($nowStudying->jadwal_id)) ?>">
                                    <div class="absen d-block justify-content-center">
                                        <div class="card bg-absen-open shadow-sm px-3 pt-3">
                                            <img src="<?= base_url() ?>assets/siswa/icons/absen.png" alt=""
                                                class="mx-auto">
                                            <p>Absen</p>
                                        </div>
                                    </div>
                            ...
                            <div class="card px-3 pt-3">
                                <div class="row">
                                    <div class="section-menu col">
                                        <a
                                            href="<?= base_url('siswa/materi/ruang_materi/' . $this->secure->encrypt_url($nowStudying->jadwal_id)) ?>">
                                            <div class="menu">
                                                <div class="card  py-1 mt-2 d-flex align-items-center mb-3">
                                                    <img src="<?= base_url('assets/siswa/icons/materi-pem.png') ?>"
                                                        alt="">
                                    ...
                                    <div class="section-menu col">
                                        <a
                                            href="<?= base_url('siswa/ruang_tugas/tugas_harian/' . $this->secure->encrypt_url($nowStudying->jadwal_id)) ?>">
                                            <div class="menu">
                                                <div class="card py-1 mt-2 d-flex align-items-center mb-3">
                                    ...
                                    <div class="section-menu col">
                                        <a
                                            href="<?= base_url('siswa/evaluasi/' . $this->secure->encrypt_url($nowStudying->jadwal_id)) ?>">
                                            <div class="menu">
                                                <div class="card py-1 mt-2 d-flex align-items-center mb-3">
                                                    <img src="<?= base_url('assets/siswa/icons/evaluasi.png') ?>"
                                                        alt="">
                                    ...
                                    <div class="section-menu col">
                                        <a
                                            href="<?= base_url('siswa/diskusi/ruang_diskusi/' . $this->secure->encrypt_url($nowStudying->jadwal_id)) ?>">
                                            <div class="menu">
                                                <div class="card py-1 mt-2 d-flex align-items-center mb-3">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="card shadow p-3">
                    ...
                    <!-- Mapel -->
                    <div class="jadwal">
                        <div class="mapel mt-3" data-toggle="collapse" href="#collapse-<?= $study->jadwal_id ?>"
                            role="button" aria-expanded="false" aria-controls="collapse-<?= $study->jadwal_id ?>">
                            <div class="card shadow p-2">
                                <div class="d-flex justify-content-lg-start">
                                    <img role="button"
                                        src="<?= ($study->profile == 'default_profile.png') ? base_url('assets/siswa/img/profile.png') : base_url('storage/guru/profile/' . $study->profile) ?>"
                                        alt="" class="rounded-circle mr-3" data-toggle="tooltip" data-placement="top"
                                        title="<?= $study->guru_nama ?>">
                                    <div class="mapel w-100">
                                        <center>
                                    ...
                                    <a
                                        href="<?= base_url('siswa/absensi/ruang_absensi/' . $this->secure->encrypt_url($study->jadwal_id)) ?>">
                                        <div class="absen d-block justify-content-center">
                        ...
                        <div class="features-menu collapse multi-collapse" id="collapse-<?= $study->jadwal_id ?>">
                            <div class="card px-3 pt-3">
                                <div class="row">
                                    <div class="section-menu col">
                                        <a
                                            href="<?= base_url('siswa/materi/ruang_materi/' . $this->secure->encrypt_url($study->jadwal_id)) ?>">
                                            <div class="menu">
                                                <div class="card  py-1 mt-2 d-flex align-items-center mb-3">
                                                    <img src="<?= base_url('assets/siswa/icons/materi-pem.png') ?>"
                                                        alt="">
                                    ...
                                    <div class="section-menu col">
                                        <a
                                            href="<?= base_url('siswa/ruang_tugas/tugas_harian/' . $this->secure->encrypt_url($study->jadwal_id)) ?>">
                                            <div class="menu">
                                                <div class="card py-1 mt-2 d-flex align-items-center mb-3">
                                                    <img src="<?= base_url('assets/siswa/icons/tugas.png') ?>" alt="">
                                                    <p class="my-auto pt-1">Tugas</p>
                                    ...
                                    <div class="section-menu col">
                                        <a
                                            href="<?= base_url('siswa/evaluasi/' . $this->secure->encrypt_url($study->jadwal_id)) ?>">
                                            <div class="menu">
                                                <div class="card py-1 mt-2 d-flex align-items-center mb-3">
                                                    <img src="<?= base_url('assets/siswa/icons/evaluasi.png') ?>"
                                                        alt="">
                                    ...
                                    <div class="section-menu col">
                                        <a
                                            href="<?= base_url('siswa/diskusi/ruang_diskusi/' . $this->secure->encrypt_url($study->jadwal_id)) ?>">
                                            <div class="menu">
                                                <div class="card py-1 mt-2 d-flex align-items-center mb-3">
                                                    <span class="badge-info-ds"> </span>
                                                    <img src="<?= base_url('assets/siswa/icons/diskusi.png') ?>" alt="">
    ...
    <!-- Back to top button -->
    <button type="button" class="btn btn-floating btn-sm" id="btn-back-to-top"> <img class="rotate-sm-l-45"
            src="<?= base_url('assets/') ?>home/images/favicon.png" alt=""></button>
