                ...
                <div class="activity">
                    <div class="card shadow mb-4">
                        <div class="container my-3"> 
                            <form action="">
                                <label for="judul">Judul Video Pembelajaran</label>
                                <div class="input-group mb-3">
                                    <input type="text" name="" id="" placeholder="Masukan Judul Video Pembelajaran" class="form-control">
                                </div>
                                <label for="guru">Link</label>
                                <div class="input-group mb-3">
                                    <input type="text" name="" id="" placeholder="Masukan Link Youtube" class="form-control">
                                </div>
                                <div class="input-group mb-3">
