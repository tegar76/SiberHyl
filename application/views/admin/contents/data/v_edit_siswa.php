                        ...
                        <div class="card shadow mb-4">
                            <div class="container my-3"> 
                                <form action="">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="form-check ml-3 mr-3">
                                            <input class="form-check-input" type="radio" name="status-siswa" id="a" value="option1" checked>
                                            <label class="form-check-label" for="a">
                                                Aktif
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="status-siswa" id="t" value="option2">
