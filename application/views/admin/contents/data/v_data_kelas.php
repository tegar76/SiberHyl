...
<<<<<<< HEAD <script src="<?= base_url('assets/admin/js/data-table/mainnnn.js') ?>">
	</script>
										...
										foreach ($classes as $class) : ?>
											<tr>
												...
												<td class="d-flex justify-content-center">
													...
													<a href="#" class="btn btn-sm btn-danger delete-kelas" kode-kelas="<?= $class->kode_kelas ?>" data-toggle="tooltip" data-placement="bottom" title="Hapus"><i class="fa-solid fa-trash-can text-white"></i></a>
												</td>
											</tr>
										<?php endforeach ?>
									</tbody>
