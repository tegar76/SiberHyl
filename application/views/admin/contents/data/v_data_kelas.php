    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                <div class="card-body">
                        <h6 class="card-title">Data Kelas & Wali Kelas  Semester Gasal Tahun Pelajaran 2021/2022 </h6>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            <a href="<?= base_url('Admin/Data/editKelas')?>" class="btn btn-sm btn-success mr-2"><i class="fa-solid fa-pen-to-square text-white"  data-toggle="tooltip" data-placement="top" title="Edit"></i></a>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>XI TKRO 3</td>
                                        <td>Dwiyono Bagus Iriyanto, S.Pd.</td>
                                        <td>01 - 05 - 2022 08 : 00 WIB</td>
                                        <TD>-</TD>
                                        <td class="d-flex justify-content-center">
                                            <a href="<?= base_url('Admin/Data/editKelas')?>" class="btn btn-sm btn-success mr-2"><i class="fa-solid fa-pen-to-square text-white"  data-toggle="tooltip" data-placement="top" title="Edit"></i></a>
        ...
        <div class="floating-container">
            <a href="<?= base_url('Admin/Data/TambahKelas')?>">
