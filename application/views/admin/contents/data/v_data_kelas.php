									...
									foreach ($classes as $class) : ?>
										<tr>
											...
											<td class="d-flex justify-content-center">
												<a href="<?= base_url('master/data/kelas/editKelas/' . $class->kode_kelas) ?>" class="btn btn-sm btn-success mr-2"><i class="fa-solid fa-pen-to-square text-white" data-toggle="tooltip" data-placement="top" title="Edit"></i></a>
