	...
	<div class="page-breadcrumb">
		<div class="row">
			<div class="col-7 align-self-center">
				<h3 class="page-title">Edit Mapel</h3>
			</div>
		</div>
		<div class="d-flex align-items-center">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb m-0 p-0">
					...
					<li class="breadcrumb-item text-muted active" aria-current="page">Edit Mapel</li>
				</ol>
			</nav>
		</div>
	</div>
				...
				<div class="activity">
					...
					<div class="card shadow mb-4">
						<div class="container my-3">
							<?= form_open('master/data/mata-pelajaran/update_mapel/' . $mapel->slug_mapel) ?>
							<input type="hidden" name="mapel_id" value="<?= $mapel->mapel_id ?>">
							<label for="nama_mapel_edit">Mata Pelajaran</label>
							<div class="input-group mb-3">
								<input type="text" name="nama_mapel_edit" id="nama_mapel_edit" placeholder="Masukan Mata Pelajaran" class="form-control <?= (form_error('nama_mapel_edit')) ? 'is-invalid' : '' ?>" value="<?= $mapel->nama_mapel ?>">
								<div class="invalid-feedback">
									<?= form_error('nama_mapel_edit', '<div class="text-danger">', '</div>') ?>
								</div>
							</div>
							<div class="btn-aksi">
