        ...
        <div class="d-flex align-items-center">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-0 p-0">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="<?= base_url('Admin/Info/tahunPembelajaran')?>" class="text-muted">Tahun Pembelajaran</a></li>
                ...
                <div class="activity">
                        ...
                        <div class="card shadow mb-4">
                            <div class="container my-3"> 
                                <form action="">
                                    <label for="kelas">Tahun Pembelajaran</label>
                                    <div class="input-group mb-3">
                                        <input type="text" name="" id="" placeholder="Masukan Tahun Pembelajaran" class="form-control">
                                    </div>
                                    <label for="guru">Semester</label>
                                    <div class="input-group mb-3">
