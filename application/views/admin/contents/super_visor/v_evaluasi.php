							...
							<table id="evaluasi" class="table-responsive table-striped table-bordered" style="width:100%">
								...
								<tbody>
									<tr>
										...
										<td>
											<a href="<?= base_url('Admin/SuperVisor/detailEvaluasi')?>" class="btn btn-sm btn-success border-0 rounded"><i class="fa fa-search text-white" data-toggle="tooltip" data-placement="top" title="Detail"></i></a>
										</td>
									</tr>
								</tbody>
							</table>
