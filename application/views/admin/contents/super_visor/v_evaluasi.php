								...
								<tbody>
									<?php foreach ($evaluasi as $key => $value) : ?>
										<tr>
											...
											<td><?= $value['create'] ?></td>
											<td>
												<a href="<?= base_url($level . '/super-visor/detail_evaluasi/' . $value['id_']) ?>" class="btn btn-sm btn-success border-0 rounded"><i class="fa fa-search text-white" data-toggle="tooltip" data-placement="top" title="Detail"></i></a>
											</td>
										</tr>
									<?php endforeach ?>
								</tbody>
