							...
							<table class="table-responsive table-bordered" style="width:100%">
								...
								<tbody>
									<tr>
										...
										<td>
											<a target="_blank" href="<?= base_url('Admin/SuperVisor/fileSoalTugasHarian')?>" class="btn btn-sm btn-success border-0 rounded mr-1"><i class="fa fa-search text-white" data-toggle="tooltip" data-placement="top" title="detail"></i></a>
										</td>
									</tr>
								</tbody>
							</table>
							...
							<table id="data_siswa" class="table-responsive table-striped table-bordered" style="width:100%">
								...
								<tbody>
									<tr>
										...
										<td>Online</td>
										<td><a target="_blank" href="<?= base_url('Admin/SuperVisor/fileJawabanTugasHarianImg')?>"><img src="<?= base_url('assets/admin/icons/img.png') ?>" alt=""></a></td>
										<td>Bagus</td>
										<td>95</td>
										<td>Sudah Dinilai</td>
									</tr>
									...
									<tr>
										...
										<td>10 - 04 - 2022 13:00 WIB</td>
										<td>Online</td>
										<td><a target="_blank" href="<?= base_url('Admin/SuperVisor/fileJawabanTugasHarianPdf')?>"><img src="<?= base_url('assets/admin/icons/pdf.png') ?>" alt=""></a></td>
										<td>-</td>
										<td>-</td>
