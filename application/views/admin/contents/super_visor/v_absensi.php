								...
								<tbody>
									<?php foreach ($absensi as $row) : ?>
										<tr>
											...
											<td><?= $row['tanggal'] ?></td>
											<td>
												<a href="<?= base_url($level . '/super-visor/detail_absensi/' . $row['jurnalid']) ?>" class="btn btn-sm btn-success border-0 rounded"><i class="fa fa-search text-white" data-toggle="tooltip" data-placement="top" title="Detail"></i></a>
											</td>
										</tr>
									<?php endforeach ?>
								</tbody>
