<div class="page-wrapper">
                        ...
                        <div class="card-body">
                            <section>
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="row">
                                            <a href="<?= base_url('WaliKelas/Konsultasi/detailKonsultasi')?>" class="ml-3 mt-n2">
                                        ...
                                        <div class="subjek mt-n2 mb-2">Judul Konsultasi</div>
	...
	<div class="floating-container">
		<a href="<?= base_url('WaliKelas/Konsultasi/tambahKonsultasi') ?>">
