		...
		<div class="d-flex align-items-center">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb m-0 p-0">
					...
					<li class="breadcrumb-item" aria-current="page"><a href="<?= base_url('wali-kelas/data/data_siswa') ?>" class="text-muted">Data Siswa</a></li>
							...
							<div class="col-md-8">
								<div class="card shadow px-3">
									...
									<div class="button-action d-flex mb-3 mt-2">
										<a href="<?= base_url('wali-kelas/data/data_siswa') ?>" class="btn btn-sm btn-primary bg-blue border-0 rounded ml-3 px-3">Kembali</a>
									</div>
								</div>
							</div>
						</div>
