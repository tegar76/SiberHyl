<div class="page-wrapper">
        ...
        <div class="d-flex align-items-center">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-0 p-0">
                    <li class="breadcrumb-item text-muted active"><a
                            href="<?= base_url($this->session->userdata('level') . '/dashboard') ?>"
                                ...
                                <div class="card shadow px-3 pt-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex justify-content-beetween">
                                            <input type="password"
                                                class="form-control <?= (form_error('old_pass')) ? 'is-invalid' : '' ?>"
                                                name="old_pass" value="<?= set_value('old_pass') ?>"
                                                id="id_password_lama">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex justify-content-beetween">
                                            <input type="password"
                                                ...
                                                name="new_pass" value="<?= set_value('new_pass') ?>"
                                                id="id_password_baru">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex justify-content-beetween">
                                            <input type="password"
                                                class="form-control <?= (form_error('conf_pass')) ? 'is-invalid' : '' ?>"
                                                name="conf_pass" id="id_password_baru_konfirmasi">
                                            <i class="icon-show-pw far fa-eye fa-xs"
                                                id="toggle_id_password_baru_konfirmasi"></i>
                                        </div>
                                        <?= form_error('conf_pass', '<small class="text-danger">', '</s>') ?>
                                    </div>
                                    <div class="button-action d-flex mb-3 mt-2">
                                        <button type="submit"
                                            class="btn btn-sm btn-success rounder mr-2 px-4">Update</button>
                                        <button type="reset"
                                            class="btn btn-sm btn-secondary rounder px-4">Reset</button>
                                    </div>
                                    <?= form_close() ?>
                                </div>
                            </div>
    ...
    togglePasswordBaruKonfirmasi.addEventListener('click', function(e) {
        // toggle the type attribute
        const typeBaruKonfirmasi = passwordBaruKonfirmasi.getAttribute('type') === 'password' ? 'text' :
            'password';
