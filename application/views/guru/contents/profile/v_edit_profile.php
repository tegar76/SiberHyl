        ...
        <div class="d-flex align-items-center">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-0 p-0">
                    ...
                    <li class="breadcrumb-item text-muted active"><a
                            href="<?= base_url($this->session->userdata('level') . '/profile') ?>"
                            ...
                            <div class="col-md-4 text-center mb-3">
                                <div class="card shadow py-4">
                                    <div class="img-photo justify-content-center">
                                        ...
                                        <?php else : ?>
                                        <img class="mx-auto d-block rounded-circle"
                                            src="<?= base_url('storage/guru/profile/' . $guru->profile) ?>" width="150"
                                            height="150" alt="<?= $guru->guru_nama ?>">
                                        <?php endif ?>
                                    </div>
                                    <div class="line">
                                        <hr>
                            ...
                            <div class="col-md-8">
                                <div class="card shadow px-3 pt-3">
                                    <div class="form-group">
                                        ...
                                        <input name="kode_guru" id="kode_guru" type="text" class="form-control"
                                            value="<?= $guru->guru_kode ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="nama_guru">Nama</label>
                                        <input name="nama_guru" id="nama_guru" type="text" class="form-control"
                                            value="<?= $guru->guru_nama ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="nip_guru">NIP/NUPTK</label>
                                        <input name="nip_guru" id="nip_guru" type="text" class="form-control"
                                            value="<?= $guru->guru_nip ?>" readonly>
                                    </div>
                                    <div class="button-action mb-5 mt-2">
                                        <button type="submit"
                                            class="btn btn-sm btn-success rounded mr-2 px-4">Update</button>
                                        <button type="reset"
                                            class="btn btn-sm btn-secondary rounded px-4">Reset</button>
                                    </div>
                                </div>
                            </div>
                        </div>
