					...
					<div class="card-body">
						...
						<div class="sub-title">
							<div class="info">
								...
								<p>Kode Guru : <span class="ml-2"><?= (!empty($wali->guru_kode)) ? $wali->guru_kode : '' ?></span></p>
							</div>
						</div>
						<div class="mt-4 activity">
							<table id="table-data-siswa" class="table-responsive table-striped table-bordered" style="width:100%">
								...
								<tbody>
									<?php foreach ($students as $row) : ?>
										<tr>
											...
											<td><?= $row['online'] ?></td>
											<td>
												<a href="<?= base_url("guru/data/detail_siswa/kelas/{$row['kelas']}?nis={$row['nis']}") ?>" class="btn btn-sm btn-primary bg-blue border-0 rounded"><i class="fa fa-search text-white" data-toggle="tooltip" data-placement="top" title="Detail"></i></a>
											</td>
										</tr>
									<?php endforeach; ?>
								</tbody>
