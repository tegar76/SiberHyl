		...
		<div class="d-flex align-items-center">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb m-0 p-0">
					...
					<li class="breadcrumb-item" aria-current="page"><a href="<?= base_url('Guru/Data/dataSiswa') ?>" class="text-muted">Data Siswa</a></li>
								...
								<div class="card shadow py-4">
									...
									<div class="atribute px-3">
										...
										<div class="info text-left ml-2">
											...
											<p class="mb-n1">Diubah : &ensp;<span>-</span></p>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-8">
								<div class="card shadow px-3">
									...
									<div class="button-action d-flex mb-3 mt-2">
										<a href="<?= base_url('Guru/Data/dataSiswa') ?>" class="btn btn-sm btn-primary bg-blue border-0 rounded ml-3 px-3">Kembali</a>
									</div>
								</div>
							</div>
						</div>
