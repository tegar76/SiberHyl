<div class="page-wrapper">
		...
		<div class="d-flex align-items-center">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb m-0 p-0">
					...
					<li class="breadcrumb-item" aria-current="page"><a href="<?= base_url('guru/pembelajaran/absensi/' . $info->jadwal_id) ?>" class="text-muted">Absensi</a></li>
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-12">
				<div class="activity">
					<?= form_open('guru/export/absensi_siswa/' . $info->jadwal_id) ?>
					...
					<div class="card shadow mb-4">
						<div class="container my-3">
							...
							<div class="input-group mb-3">
								<input type="text" name="format_export" id="format_export" class="form-control <?= (form_error('format_export')) ? 'is-invalid' : '' ?>" value="pdf" readonly>
