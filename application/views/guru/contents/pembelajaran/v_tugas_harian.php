...
<div class="page-wrapper">
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<a href="<?= base_url('guru/export/tugas_harian/' . $info->jadwal_id) ?>">
						...
						<h6 class="card-title">
							Data Tugas Harian Kelas <?= $info->nama_kelas ?> Semester <?= $semester = ($tahun_ajar['semester'] == 0) ? '-' : (($tahun_ajar['semester'] % 2 == 0) ? 'Genap' : 'Gasal') ?> Tahun Pelajaran <?= ($tahun_ajar['tahun'] == '') ? '-' : $tahun_ajar['tahun'] ?>
						</h6>
								...
								<tbody>
									<?php foreach ($tugas as $row) : ?>
										<tr>
											...
											<td><?= $row['update'] ?></td>
											<td>
												<a href="<?= base_url('guru/pembelajaran/detail_tugas_harian/' . $row['idTugas']) ?>" class="btn btn-sm btn-success border-0 rounded"><i class="fa fa-search text-white" data-toggle="tooltip" data-placement="top" title="Detail"></i></a>
											</td>
										</tr>
									<?php endforeach ?>
								</tbody>
	...
	<div class="floating-container">
		<a href="<?= base_url('guru/pembelajaran/tambah_tugas_harian/' . $info->jadwal_id) ?>">
