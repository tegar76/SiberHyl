	<div class="page-wrapper">
			...
			<div class="d-flex align-items-center">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb m-0 p-0">
						...
						<li class="breadcrumb-item" aria-current="page"><a href="<?= base_url('guru/pembelajaran/evaluasi/' . $result['jadwal_id']) ?>" class="text-muted">Evaluasi</a></li>
						<li class="breadcrumb-item" aria-current="page"><a href="<?= base_url('guru/pembelajaran/detail_evaluasi/' . $result['evaluasi_id']) ?>" class="text-muted">Detail Evaluasi</a></li>
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-12">
					<div class="activity">
						<?= form_open('guru/pembelajaran/process_nilai_evaluasi') ?>
						<div class="card shadow mb-4">
							<div class="container my-3">
								...
								<div class="input-group mb-3">
									<?php if ($result['metode'] == 'online') : ?>
										<?php if ($result['file_ext'] == '.pdf') : ?>
											<a target="_blank" href="<?= base_url('guru/pembelajaran/file_evaluasi_siswa/' . $result['id']) ?>"><img src="<?= base_url('assets/admin/icons/pdf.png') ?>" alt=""></a>
										<?php else : ?>
											<a target="_blank" href="<?= base_url('guru/pembelajaran/file_evaluasi_siswa/' . $result['id']) ?>"><img src="<?= base_url('assets/admin/icons/img.png') ?>" alt=""></a>
										<?php endif ?>
								...
								<input type="hidden" name="evaluasi_id" value="<?= $result['evaluasi_id'] ?>">
								<input type="hidden" name="evaluasi_siswa_id" value="<?= $result['id'] ?>">
