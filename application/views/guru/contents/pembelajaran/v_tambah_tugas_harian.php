							...
							<div class="container my-3">
								...
								<div class="row">
									<div class="col">
										...
										<div class="input-group mb-3">
											<input type="text" name="" id="" class="form-control" placeholder="Masukan Judul Tugas">
										</div>
									</div>
									<div class="col">
								...
								<div class="input-group mb-3">
									<textarea name="" id="" placeholder="Masukan Deskripsi Tugas" class="form-control"></textarea>
								</div>
								<label for="">Unggah File Tugas</label>
								<div class="input-group mb-3">
