					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
							<a class="dropdown-item" href="<?= base_url('guru/profile') ?>"><i data-feather="user" class="svg-icon mr-2 ml-1"></i>
								Profil</a>
							<a class="dropdown-item" href="<?= base_url('guru/profile/update_password') ?>"><i data-feather="key" class="svg-icon mr-2 ml-1"></i>
								Edit Password</a>
							<hr>
							<a class="dropdown-item" href="javascript:void(0)" id="logout"><i data-feather="power" class="svg-icon mr-2 ml-1"></i>
								Logout</a>
					</li>
					<!-- ============================================================== -->
					<!-- User profile and search -->
