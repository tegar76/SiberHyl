		...
		<div class="d-flex align-items-center">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb m-0 p-0">
					...
					<li class="breadcrumb-item" aria-current="page"><a href="<?= base_url('kepala_sekolah/master_data/guru') ?>" class="text-muted">Data Guru</a></li>
							...
							<div class="col-md-9">
								<div class="card shadow px-3">
									...
									<div class="button-action d-flex mb-3 mt-2">
										<a href="<?= base_url('kepala_sekolah/master_data/guru') ?>" class="btn btn-sm btn-primary rounded ml-3 px-3 text-white">Kembali</a>
									</div>
								</div>
							</div>
						</div>
