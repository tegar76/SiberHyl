	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<a href="<?= base_url('KepalaSekolah/SuperVisor/formCetakReportAbsensi')?>">
							...
							<table id="absensi" class="table-responsive table-striped table-bordered" style="width:100%">
								...
								<tbody>
									<tr>
										...
										<td>01 - 05 - 2022</td>
										<td>
											<a href="<?= base_url('KepalaSekolah/SuperVisor/detailAbsensi')?>" class="btn btn-sm btn-success border-0 rounded"><i class="fa fa-search text-white" data-toggle="tooltip" data-placement="top" title="Detail"></i></a>
										</td>
									</tr>
								</tbody>
							</table>
