									...
									<div class="card px-3 mt-n5">
										<div class="row ml-2">
											<div class="section-menu mr-3">
												<a href="<?= base_url('KepalaSekolah/SuperVisor/absensi')?>">
													<div class="menu">
											...
											<div class="section-menu mr-3">
												<a href="<?= base_url('KepalaSekolah/SuperVisor/tugasHarian')?>">
													<div class="menu">
														<div class="card py-1 mt-2 d-flex align-items-center mb-1" style="width:55px">
											...
											<div class="section-menu mr-3">
												<a href="<?= base_url('KepalaSekolah/SuperVisor/evaluasi')?>">
													<div class="menu">
														<div class="card py-1 mt-2 d-flex align-items-center mb-1" style="width:55px">
											...
											<div class="section-menu mr-3">
												<a href="<?= base_url('KepalaSekolah/SuperVisor/diskusi')?>">
													<div class="menu">
														<div class="card py-1 mt-2 d-flex align-items-center mb-1" style="width:55px">
											...
											<div class="section-menu mr-3">
												<a href="<?= base_url('KepalaSekolah/SuperVisor/jurnalMateri')?>">
													<div class="menu">
														<div class="card  py-1 mt-2 d-flex align-items-center mb-1" style="width:55px">
